// Raw MIDI demonstration sketch for SoMo V5
//
// This sketch reads the IMU, scales values to MIDI range (0-127), and sends them as MIDI CC's 20-29
//
...
*/
    ...
    byte amcc = AccelMagnitudeToCC(ax,ay,az);  // Absolute Magnitude with gravity removed
